            ...
            <div class="row gutters-10">
                    ...
                    <div class="row gutters-10">
                        <div class="col-6">
                            <div class="bg-grad-2 text-white rounded-lg mb-4 overflow-hidden">
                                <div class="px-3 pt-3">
                                    <div >
                                        <span class="fs-12 d-block">Total</span>Customer
                                    </div>
                        ...
                        <div class="col-6">
                            <div class="bg-grad-3 text-white rounded-lg mb-4 overflow-hidden">
                                <div class="px-3 pt-3">
                                    <div >
                                        <span class="fs-12 d-block">Total</span>Order
                                    </div>
                        ...
                        <div class="col-6">
                            <div class="bg-grad-1 text-white rounded-lg mb-4 overflow-hidden">
                                <div class="px-3 pt-3">
                                    <div >
                                        <span class="fs-12 d-block">Total</span>Products (all categories)
                                    </div>
                        ...
                        <div class="col-6">
                            <div class="bg-grad-4 text-white rounded-lg mb-4 overflow-hidden">
                                <div class="px-3 pt-3">
                                    <div >
                                        <span class="fs-12 d-block">Total</span>Feedbacks
                                    </div>
                ...
                <div class="col-lg-6">
                    <div class="card shadow mb-4">
                        <!--Card Header-Dropdown--><div class="card-header py-3 d-flex flex-row align-items-center justify-content-between" style="background-color: whitesmoke;">
