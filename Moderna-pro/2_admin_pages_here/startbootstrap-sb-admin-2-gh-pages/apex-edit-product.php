                                ...
                                <div class="col-lg-12" style="margin: auto;">
                                    <div class="card" style="margin: auto;">
                                        <div class="card-body">
                                            <div class="row mb-3">
                                                <div class="col-sm-3">
                                                <form action = /MasterCLEO/Moderna-pro/2_admin_pages_here/startbootstrap-sb-admin-2-gh-pages/apexedit.php method = "POST">
                                                    <h6 class="mb-0">ID</h6>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 text-secondary">
                                                    <input type="submit" class="btn btn-primary px-4" value="Save Changes" name = "apexedit">
                                                </form> 
                                                </div>
                                            </div>
                                        </div>
