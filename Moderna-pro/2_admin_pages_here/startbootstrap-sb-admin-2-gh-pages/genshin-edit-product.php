...
<body style="background-color: #B7569A;">
    <!-- Page Wrapper --><div id="wrapper">
        <!-- Sidebar --><ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Order Purchase --><li class="nav-item">
                ...
                <!-- Topbar --><nav class="navbar navbar-expand navbar-light bg-custompurple2 topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Navbar --><ul class="navbar-nav ml-auto">
                        <!-- Nav Item - Search Dropdown (Visible Only XS) --><li class="nav-item dropdown no-arrow d-sm-none">
                            ...
                            <!-- Dropdown - Messages --><div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in"
                ...
                <!-- Begin Page Content --><div class="container-fluid">
                    ...
                    <div class="container col-lg-12">
                        ...
                        <button class="yellow-buttonloh" type="button" style="float:right;margin: 0px 20px;width:100px;height:33px;">
                            <a href="genshin-product-list.php" style="color: #fff;">Back</a></button>
                            <br>
                        </div>
                        <div class="main-body">
                            <div class="row">
                                    ...
                                    <div class="card" style="margin: auto;">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 text-secondary">
                                                    <input type="submit" class="btn btn-primary px-4" value="Save Changes" name = "genshinedit">
                                                </form> 
                                                </div>
                                            </div>
                                        </div>
