            ...
            <div id="content" style="background-color: #B7569A;">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0" style="color: #fff;">Edit PUBG Product</h1>
                    ...
                    <div class="container col-lg-12">
                        ...
                        <button class="yellow-buttonloh" type="button" style="float:right;margin: 0px 20px;width:100px;height:33px;">
                            <a href="pubg-product-list.php" style="color: #fff;">Back</a></button>
                            <br>
                        </div>
                        <div class="main-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12" style="margin: auto;">
                                    <div class="card" style="margin: auto;">
                                        <div class="card-body">
                                            <div class="row mb-3">
                                                <div class="col-sm-3">
                                                <form action = "/2_admin_pages_here/startbootstrap-sb-admin-2-gh-pages/pubgedit.php" method = "POST">
                                                    <h6 class="mb-0">ID</h6>
                                                </div>
