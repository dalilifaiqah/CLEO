          ...
          <div class="row gy-4">
              ...
              <div class="portfolio-details-slider swiper-container">
                <div class="swiper-wrapper align-items-center">
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/gamepoints-picture/apex1.png" alt="">
                  </div>
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/gamepoints-picture/apex3.jpg" alt="">
                  </div>
            ...
            <div class="col-lg-7">
              <div class="portfolio-info" style="background-color: white;">
                ...
                <ul>
                  <li><strong>Name </strong>: Apex Coins</li>
                  <li><strong>Category </strong>: Apex Legends</li>
                  <li id="apexcoinprofile" value="apexcoin"><strong>Price </strong>: RM </li> <!---->
                  <li><strong>Variation</strong>: 
                    ...
                    <form>
                      ...
                      <label class="radio-inline">
                        <input type="radio" name="optradio" > 1000 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                        <input type="radio" name="optradio"> 2000 (+150 Bonus) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                        <input type="radio" name="optradio"> 4000 (+350 bonus) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                          <input type="radio" name="optradio"> 6000 (+750 bonus) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                          <input type="radio" name="optradio"> 10000 (+1,500 bonus) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <!--<label class="radio-inline">
            ...
            <div class="portfolio-description">
              ...
              <p>
                ...
                <strong>- Can i add other legends skins while purchasing Apex Coins at the same time?</strong>
                <br> YES <br>
                <strong>- How do i add other legends skins while purchasing Apex Coins at the same time?</strong>
                <br> Add to cart the legends skins you needed<br>
