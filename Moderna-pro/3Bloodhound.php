...
<head>
  ...
  <title>Projector of The Patch Bloodhound</title>
          ...
          <div class="row gy-4">
              ...
              <div class="portfolio-details-slider swiper-container">
                <div class="swiper-wrapper align-items-center">
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/size-formated/bloodhound-apex.jpg" alt="">
                  </div>
            ...
            <div class="col-lg-7">
              <div class="portfolio-info" style="background-color: white;">
                ...
                <ul>
                  <li><strong>Name </strong>: Projector of The Patch Bloodhound</li>
                  <li><strong>Category </strong>: Apex Legends</li>
                  <li id="Bloodhoundprofile" value="Bloodhound"><strong>Price </strong>: RM 80.00</li> <!---->
            ...
            <div class="portfolio-description">
              <h2>Descriptions</h2>
              <p>
                This only requires <strong>one Bloodhound's Skin.</strong>
