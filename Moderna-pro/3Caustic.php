...
<head>
  ...
  <title>BlackHeart Caustic</title>
          ...
          <div class="row gy-4">
              ...
              <div class="portfolio-details-slider swiper-container">
                <div class="swiper-wrapper align-items-center">
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/size-formated/caustic-apex.jpg" alt="">
                  </div>
            ...
            <div class="col-lg-7">
              <div class="portfolio-info" style="background-color: white;">
                ...
                <ul>
                  <li><strong>Name </strong>: BlackHeart Caustic</li>
                  <li><strong>Category </strong>: Apex Legends</li>
                  <li id="Causticprofile" value="Caustic"><strong>Price </strong>: RM 80.00</li> <!---->
            ...
            <div class="portfolio-description">
              <h2>Descriptions</h2>
              <p>
                This only requires <strong>one Caustic's Skin.</strong>
