...
<head>
  ...
  <title>Chang-E Mobile Legends</title>
          ...
          <div class="row gy-4">
              ...
              <div class="portfolio-details-slider swiper-container">
                <div class="swiper-wrapper align-items-center">
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/size-formated/chang-e-mobileLegend.jpg" alt="">
                  </div>
            ...
            <div class="col-lg-7">
              <div class="portfolio-info" style="background-color: white;">
                ...
                <ul>
                  <li><strong>Name </strong>: Chang-E</li>
                  <li><strong>Category </strong>: Mobile Legends</li>
                  <li id="ChangEprofile" value="ChangE"><strong>Price </strong>: RM 80.00</li> <!---->
            ...
            <div class="portfolio-description">
              <h2>Descriptions</h2>
              <p>
                This <strong>ONLY</strong> requires the hero Chang-E.
