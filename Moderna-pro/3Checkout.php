  ...
  <main id="main">
    ...
    <div class="row" >
      <div class="info-box" style="padding: 123px 10px 122px 10px">
        <div class=" well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3" style="margin:auto; padding: 0 10px 0 10px; width:80%;" >
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 text-right" style="text-align:right">
                    <p>
                        <em>Date: 30 October 2021 </em>
                    </p>
                    <p>
            ...
            <div class="row">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            <td class="col-md-5" style="text-align:left"><em>Vintage Rock ScarL</em></h4></td>
                            <td class="col-md-1" style="text-align: center"> 1 </td>
                            <td class="col-md-2 text-center">RM 150.00</td>
                            <td class="col-md-2 text-center">RM 150.00</td>
                        </tr>
                        <!--<tr>
                            <td class="col-md-9" style="text-align:left"><em>Lebanese Cabbage Salad</em></h4></td>
                            <td class="col-md-1" style="text-align: center"> 1 </td>
                            <td class="col-md-1 text-center">RM 0.00</td>
                            <td class="col-md-1 text-center">RM 0.00</td>
                        </tr>-->
                        <!--<tr>
                            <td class="col-md-9" style="text-align:left"><em>Baked Tart with Thyme and Garlic</em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="text-center text-danger"><h4><strong>RM 155.00</strong></h4></td>
                        </tr>
                    </tbody>
                </table>
