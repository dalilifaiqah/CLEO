...
<head>
  ...
  <title>Mobile Legends Diamonds</title>
          ...
          <div class="row gy-4">
              ...
              <div class="portfolio-details-slider swiper-container">
                <div class="swiper-wrapper align-items-center">
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/gamepoints-picture/mobilelegend1.jpg" alt="">
                  </div>
  
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/size-formated/mobilelegendlogo.jpg" alt="">
                  </div>
  
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/gamepoints-picture/mobilelegend2.jpg" alt="">
                  </div>
  
                  <div class="swiper-slide">
                      <img src="assets/img/portfolio/gamepoints-picture/mobilelegend3.png" alt="">
                  </div>
            ...
            <div class="col-lg-7">
              <div class="portfolio-info" style="background-color: white;">
                ...
                <ul>
                  <li><strong>Name </strong>: Mobile Legends Diamonds</li>
                  <li><strong>Category </strong>: Mobile Legends</li>
                  <li id="Diamondsprofile" value="Diamonds"><strong>Price </strong>: RM </li> <!---->
                  <li><strong>Variation</strong>: 
                    ...
                    <form>
                      ...
                      <label class="radio-inline">
                        <input type="radio" name="optradio" > 10 (+1 Bonus) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                        <input type="radio" name="optradio"> 20 (+2 Bonus) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                        <input type="radio" name="optradio"> 51 (+5 Bonus) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                          <input type="radio" name="optradio"> 102 (+10 Bonus) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                          <input type="radio" name="optradio"> 203 (+20 Bonus) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                          <input type="radio" name="optradio"> 303 (+33 Bonus) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                          <input type="radio" name="optradio"> 504 (+66 Bonus) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                          <input type="radio" name="optradio"> 1007 (+156 Bonus) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                          <input type="radio" name="optradio"> 2015 (+383 Bonus) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                          <input type="radio" name="optradio"> 5035 (+1007 Bonus) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <br><br>
            ...
            <div class="portfolio-description">
              <h2>Descriptions</h2>
              <p>
                Diamonds are a currency in Mobile Legends that you can use to unlock certain heroes. 
                So, as you might expect, they are in pretty high demand. 
                You can unlock a lot of heroes using battle points, which you can earn in-game, and tickets, which you can get through the jigsaw event.
                ...
                <strong>- Can i add other hero skins while purchasing Diamonds at the same time?</strong>
                <br> YES <br>
                <strong>- How do i add other hero skins while purchasing Diamonds at the same time?</strong>
                <br> Add to cart the hero skins you needed<br>
