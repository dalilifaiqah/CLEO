          ...
          <div class="row gy-4">
              ...
              <div class="portfolio-details-slider swiper-container">
                <div class="swiper-wrapper align-items-center">
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/size-formated/fuse-apex.jpg" alt="">
                  </div>
            ...
            <form method="post" action="cartdb.php">
              <div class="portfolio-info" style="background-color: white;">
                ...
                <ul>
                <li><strong>Name </strong>: <input class="nokotak" type="text" name="hidden_name" value="Pearl White Fuse" readonly/></li>
            ...
            <div class="portfolio-description">
              <h2>Descriptions</h2>
              <p>
                This only requires <strong>one Fuse's Skin.</strong>
