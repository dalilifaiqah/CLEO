...
<head>
  ...
  <title>Genesis Crystals Genshin Impact</title>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper-container">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/portfolio/gamepoints-picture/genshin1.jpg" alt="">
                </div>
                ...
                <div class="swiper-slide">
                  <img src="assets/img/portfolio/gamepoints-picture/genshin2.jpg" alt="">
                </div>

                <div class="swiper-slide">
                    <img src="assets/img/portfolio/gamepoints-picture/genshin3.jpg" alt="">
                </div>
          ...
          <div class="col-lg-7">
            <div class="portfolio-info" style="background-color: white;">
              ...
              <ul>
                <li><strong>Name </strong>: Genesis Crystals</li>
                <li><strong>Category </strong>: Genshin Impact</li>
                <li id="Genesisprofile" value="Genesis"><strong>Price </strong>: RM </li> <!---->
                <li><strong>Variation</strong>: 
                  ...
                  <form>
                    ...
                    <label class="radio-inline">
                      <input type="radio" name="optradio"> 300 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="optradio"> 980 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="optradio"> 1980 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="optradio"> 3280 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="optradio"> 6480 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </label>
                    <br><br>
            ...
            <div class="portfolio-description">
              <h2>Descriptions</h2>
              <p>
                Genesis Crystals are the in-game premium currency in Genshin Impact. 
                These can be used to redeem Primogems which are used in exchanging for Wishes to be used in the gacha. 
                They can also be spent on other bundles of in-game items.
                ...
                <strong>- Can i add other character while purchasing Genesis Crystal at the same time?</strong>
                <br> YES <br>
                <strong>- How do i add other character while purchasing Genesis Crystal at the same time?</strong>
                <br> Add to cart the character you needed<br>
