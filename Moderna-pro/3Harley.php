...
<head>
  ...
  <title>Harley Mobile Legends</title>
          ...
          <div class="row gy-4">
              ...
              <div class="portfolio-details-slider swiper-container">
                <div class="swiper-wrapper align-items-center">
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/size-formated/harley-mobileLegend.jpg" alt="">
                  </div>
  
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/mobilelegendlogo.jpg" alt="">
                  </div>
            ...
            <form method="post" action="cartdb.php">
              <div class="portfolio-info" style="background-color: white;">
                ...
                <ul>
                <li><strong>Name </strong>: <input class="nokotak" type="text" name="hidden_name" value="Harley" readonly/></li>
            ...
            <div class="portfolio-description">
              <h2>Descriptions</h2>
              <p>
                This <strong>ONLY</strong> requires the hero Harley.
                ...
                <strong>- Can i add other hero?</strong>
                <br> YES <br>
                <strong>- How do i add other hero?</strong>
                <br> Add to cart the hero you needed <br>
