...
<head>
  ...
  <title>Kamisato Ayaka Genshin Impact</title>
          ...
          <div class="row gy-4">
              ...
              <div class="portfolio-details-slider swiper-container">
                <div class="swiper-wrapper align-items-center">
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/size-formated/kamisatoayaka-genshin.jpg" alt="">
                  </div>
            ...
            <div class="col-lg-7">
              <div class="portfolio-info" style="background-color: white;">
                ...
                <ul>
                  <li><strong>Name </strong>: Kamisato Ayaka</li>
                  <li><strong>Category </strong>: Genshin Impact</li>
                  <li id="Ayakaprofile" value="Ayaka"><strong>Price </strong>: RM 350.00</li> <!---->
