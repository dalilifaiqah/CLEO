...
<head>
  ...
  <title>Laughing Fool Octane</title>
          ...
          <div class="row gy-4">
              ...
              <div class="portfolio-details-slider swiper-container">
                <div class="swiper-wrapper align-items-center">
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/size-formated/octane-apex.jpg" alt="">
                  </div>
            ...
            <div class="col-lg-7">
              <div class="portfolio-info" style="background-color: white;">
                ...
                <ul>
                  <li><strong>Name </strong>: Laughing Fool Octane</li>
                  <li><strong>Category </strong>: Apex Legends</li>
                  <li id="Octaneprofile" value="Octane"><strong>Price </strong>: RM 80.00</li> <!---->
            ...
            <div class="portfolio-description">
              <h2>Descriptions</h2>
              <p>
                This only requires <strong>one Octane's Skin.</strong>
