        ...
        <div class="row gy-4">
          ...
          <form method="post" action="cartdb.php">
            <div class="portfolio-info" style="background-color: white;">
              ...
              <ul>
                <li><strong>Name </strong>: <input name="hidden_name" value="Oni Bundle" /></li>
                <li><strong>Category </strong>: Valorant</li>
                <li><strong>Price </strong>: <input name="hidden_price" value="130.00" /></li>
            ...
            <div class="portfolio-description">
              <h2>Descriptions</h2>
              <p>
                This <strong>ONLY</strong> requires the Oni Bundle.
                <br>Which is Phantom, Guardian, Shorty, Bucky and Oni Claw.
