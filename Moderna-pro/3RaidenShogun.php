...
<head>
  ...
  <title>Raiden Shogun Genshin Impact</title>
          ...
          <div class="row gy-4">
              ...
              <div class="portfolio-details-slider swiper-container">
                <div class="swiper-wrapper align-items-center">
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/size-formated/raidenshogun-genshin.jpg" alt="">
                  </div>
            ...
            <div class="col-lg-7">
              <div class="portfolio-info" style="background-color: white;">
                ...
                <ul>
                  <li><strong>Name </strong>: Raiden Shogun</li>
                  <li><strong>Category </strong>: Genshin Impact</li>
                  <li id="Shogunprofile" value="Shogun"><strong>Price </strong>: RM 80.00</li> <!---->
