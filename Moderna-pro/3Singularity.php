...
<head>
  ...
  <title>Singularity Valorant</title>
          ...
          <div class="row gy-4">
              ...
              <div class="portfolio-details-slider swiper-container">
                <div class="swiper-wrapper align-items-center">
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/size-formated/singularity-valo.jpg" alt="">
                  </div>
            ...
            <form method="post" action="cartdb.php">
              <div class="portfolio-info" style="background-color: white;">
                ...
                <ul>
                <li><strong>Name </strong>: <input class="nokotak" type="text" name="hidden_name" value="Singularity Bundle" readonly/></li>
            ...
            <div class="portfolio-description">
              <h2>Descriptions</h2>
              <p>
                This <strong>ONLY</strong> requires the Singularity Bundle.
                <br>Which is Phantom, Ares, Sheriff, Spectre and Knife.
