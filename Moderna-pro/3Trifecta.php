          ...
          <div class="row gy-4">
              ...
              <div class="portfolio-details-slider swiper-container">
                <div class="swiper-wrapper align-items-center">
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/size-formated/scarL2-pubg.jpg" alt="">
                  </div>
            ...
            <form method="post" action="cartdb.php">
              <div class="portfolio-info" style="background-color: white;">
                ...
                <ul>
                <li><strong>Name </strong>: <input class="nokotak" type="text" name="hidden_name" value="Trifecta Scar-L" readonly/></li>
                  <li><strong>Category </strong>: PUBG</li>
                  <li><strong>Price </strong>: RM <input class="nokotak" type="text" name="hidden_price" value="60.00" readonly/></li>
            ...
            <div class="portfolio-description">
              <h2>Descriptions</h2>
              <p>
                This <strong>ONLY</strong> requires the Trifecta ScarL.
