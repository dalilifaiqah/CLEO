          ...
          <div class="row gy-4">
              ...
              <div class="portfolio-details-slider swiper-container">
                <div class="swiper-wrapper align-items-center">
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/gamepoints-picture/PUBG1.jpg" alt="">
                  </div>
  
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/size-formated/valorantlogo.jpg" alt="">
                  </div>
  
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/gamepoints-picture/PUBG2.jpg" alt="">
                  </div>
  
                  <div class="swiper-slide">
                      <img src="assets/img/portfolio/gamepoints-picture/PUBG3.jpg" alt="">
                  </div>
            ...
            <div class="col-lg-7">
              <div class="portfolio-info" style="background-color: white;">
                ...
                <ul>
                  <li><strong>Name </strong>: UC</li>
                  <li><strong>Category </strong>: PUBG</li>
                  <li id="UCprofile" value="UC"><strong>Price </strong>: RM </li> <!---->
                  <li><strong>Variation</strong>: 
                    ...
                    <form>
                      ...
                      <label class="radio-inline">
                        <input type="radio" name="optradio" > 30+4 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                        <input type="radio" name="optradio"> 60+6 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                        <input type="radio" name="optradio"> 300+40 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                          <input type="radio" name="optradio"> 600+90 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                          <input type="radio" name="optradio"> 900+160 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                          <input type="radio" name="optradio"> 1500+375 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                          <input type="radio" name="optradio"> 3000+1000 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                          <input type="radio" name="optradio"> 6000+2400 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label> <!--Reference link : https://www.pubgmobile.com/pay/ -->
                      <br><br>
            ...
            <div class="portfolio-description">
              <h2>Descriptions</h2>
              <p>
                UC (Unknown Cash) is a form of a credit or game currency in PUBG Mobile, 
                which allows players to purchase a number of premium items such as rare skins and outfits from the PUBG shop. 
                ...
                <strong>- Can i add other skins while purchasing UC at the same time?</strong>
                <br> YES <br>
                <strong>- How do i add other skins while purchasing UC at the same time?</strong>
                <br> Add to cart the skins you needed<br>
