          ...
          <div class="row gy-4">
              ...
              <div class="portfolio-details-slider swiper-container">
                <div class="swiper-wrapper align-items-center">
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/gamepoints-picture/valo1.jpg" alt="">
                  </div>
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/gamepoints-picture/valo2.jpg" alt="">
                  </div>
  
                  <div class="swiper-slide">
                      <img src="assets/img/portfolio/gamepoints-picture/valo3.png" alt="">
                  </div>
            ...
            <div class="col-lg-7">
              <div class="portfolio-info" style="background-color: white;">
                ...
                <ul>
                  <li><strong>Name </strong>: Valorant Points</li>
                  <li><strong>Category </strong>: Valorant</li>
                  <li id="Valopointsprofile" value="Valopoints"><strong>Price </strong>: RM </li> <!---->
                  <li><strong>Variation</strong>: 
                    ...
                    <form>
                      ...
                      <label class="radio-inline">
                        <input type="radio" name="optradio"> 625 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                        <input type="radio" name="optradio"> 1125 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                          <input type="radio" name="optradio"> 1650 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
                          <input type="radio" name="optradio"> 3400 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      </label>
                      <label class="radio-inline">
            ...
            <div class="portfolio-description">
              <h2>Descriptions</h2>
              <p>
                With VALORANT Points, you can get premium Battlepass rewards, 
                amazing weapon skins, unlock new Agents, purchase Radianite Points and more. 
                ...
                <strong>- Can i add other skins while purchasing Valorant points at the same time?</strong>
                <br> YES <br>
                <strong>- How do i add other skins while purchasing Valorant points at the same time?</strong>
