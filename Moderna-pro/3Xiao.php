...
<head>
  ...
  <title>Xiao Genshin Impact</title>
          ...
          <div class="row gy-4">
              ...
              <div class="portfolio-details-slider swiper-container">
                <div class="swiper-wrapper align-items-center">
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/portfolio/size-formated/xiao-genshin.jpg" alt="">
                  </div>
            ...
            <form method="post" action="cartdb.php">
              <div class="portfolio-info" style="background-color: white;">
                ...
                <ul>
                <li><strong>Name </strong>: <input class="nokotak" type="text" name="hidden_name" value="Xiao" readonly/></li>
                  <li><strong>Category </strong>: Genshin Impact</li>
                  <li><strong>Price </strong>: RM <input class="nokotak" type="text" name="hidden_price" value="240.00" readonly/></li>
