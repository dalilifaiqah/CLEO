      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a class="active"href="#"><span><?php echo $row['name']; ?></span> <i class="bi bi-chevron-down"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </i></a>
            <ul>
              <li><a class="active" href="3viewprofile.html">My Profile</a></li>
      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-md-12 profile-user">
                        <div class="info-box">
                            <img class="avatar " src="/MasterCLEO/Moderna-pro/assets/img/team-6.jpg" alt="...">
            ...
            <div class="col-lg-6 profile" >
                ...
                <form action="/MasterCLEO/3contact.php" method="POST"  class="php-email-form" style="background-color: #fff;">
                    <div class="row " >
                        <div class="col-md-12 ">
                            <h3>Profile Info</h3>
                        </div>
                    ...
                    <br><br><br><br>
                      ...
                      <button class="warnabutton" type="submit">Edit Profile Info</button> &nbsp;&nbsp;
                      <button class="warnabutton" type="submit">Edit Profiel Picture</button> &nbsp;&nbsp;
                      <button class="warnabutton" type="submit">Change Password</button>
