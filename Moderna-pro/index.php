...
<body>
  ...
  <section id="hero" class="d-flex justify-cntent-center align-items-center section-bg2">
    <div id="heroCarousel" class="container carousel carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          ...
          <!--<p class="animate__animated animate__fadeInUp">CLEO is a place where Malaysian video gamers come together to explore and find their perfect in-game materials to bring up their in game experiences to the next level. </p>
    ...
    <!-- ======= Features Section ======= -->
    <!--<section class="features whiteText">
      <div class="container">
